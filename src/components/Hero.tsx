          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              <span className="inline-flex items-center gap-2">
                <svg className="w-6 h-6 text-primary-500 animate-pulse" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8 10h.01M12 14h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8s-9-3.582-9-8 4.03-8 9-8 9 3.582 9 8z" /></svg>
                Pulsuz Konsultasiya
              </span>
            </button>
            <button
